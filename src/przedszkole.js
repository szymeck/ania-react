  ...
  return (
    <div>
      ...
      <div className="przedszkole3">
        ...
        <div className="przedszkole3-title">
          <h2>Kadra</h2>
        </div>
        <div className="przedszkole3-item">
          <div className="przedszkole3-text1">
            ...
            <ul>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Pedagogiki przedszkolenj i wczesnoszkolnej</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Pedagogiki opiekuńczo-wychowawczej</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Pedagogiki specjalnej</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Pedagogiki szkolnej i opiekuńczej</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Oligofrenopedagogiki</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Logopedii</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Psychologii</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Fizjoterapii</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Integracji Sensorycznej</li>
              <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Terapii zajęciowej</li>
            </ul>
...
<ul>
  <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Trening umiejętności społecznych – wsparcie dla dzieci z autyzem
  </li>
  <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Wykorzystanie metody integracji sensorycznej w pracy z dziećmi z
    trudnościami rozwojowymi i edukacyjnymi
  </li> 
  <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Terapia ręki</li>
  <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Wczesne wspomaganie rozwoju</li>
  <li><i class="fa fa-graduation-cap" aria-hidden="true"></i> Szkolenie SIguma Muzyczno – Sensoryczne 'Inspiracja Krainy Muzycznej'
  </li>
</ul>
          </div>
        </div>
      ...
      <div className="przedszkole4">
        <div className="przedszkole4-title">
          <h2>Kalendarz imprez</h2>
        </div>
        <div className="przedszkole4-container">
          <table>
            <tr><td>RODZAJ UROCZYSTOŚCI</td><td>TERMIN</td></tr>
            <tr><td>Dzień Przedszkolaka</td><td></td></tr>
            <tr><td>Powitanie jesieni – Święto Dyni – dzień pomarańczowy</td><td></td></tr>
            <tr><td>Światowy Dzień Uśmiechu</td><td></td></tr>
            <tr><td>Pasowanie przedszkolaków</td><td>X/XI 2023</td></tr>
            <tr><td>Święto Niepodległości</td><td>10.XI.2023</td></tr>
            <tr><td>Dzień Pluszowego Misia</td><td></td></tr>
            <tr><td>Andrzejki</td><td>30.XI.2023</td></tr>
            <tr><td>Światowy dzień Osób z Niepełnosprawnością</td><td>02.XII.2023</td></tr>
            <tr><td>Mikołajki</td><td>06.XII.2023</td></tr>
            <tr><td>Jasełka – grupy starsze</td><td>XII 2023</td></tr>
            <tr><td>Powitanie Zimy - dzień biały</td><td>22.XII.2023</td></tr>
            <tr><td>Dzień Babci i Dziadka</td><td>I.2024</td></tr>
            <tr><td>Bal karnawałowy</td><td>I.2024</td></tr>
            <tr><td>Walentynki</td><td>14.II.2024</td></tr>
            <tr><td>Święto Marchewki – dzień pomarańczowy</td><td>10.III.2024</td></tr>
            <tr><td>Powitanie Wiosny - dzień zielony</td><td>21.III.2024</td></tr>
            <tr><td>Międzynarodowy Dzień Teatru</td><td>28.III.2024</td></tr>
            <tr><td>Międzynarodowy Dzień Świadomości Autyzmu - dzień niebieski</td><td>04.IV.2024</td></tr>
            <tr><td>Międzynarodowy Dzień Ziemi</td><td>21.IV.2024</td></tr>
            <tr><td>Dzień Mamy i Taty</td><td>V .2024</td></tr>
            <tr><td>Dni otwarte w przedszkolu</td><td>VI .2024</td></tr>
            <tr><td>Dzień Dziecka</td><td>VI. 2024</td></tr>
            <tr><td>Powitanie Lata – dzień żółty</td><td>VI. 2024</td></tr>
            <tr><td>Uroczyste zakończenie roku szkolnego – pożegnanie starszaków</td><td>VI. 2024</td></tr>
          </table>
        </div>
      </div>
    </div>
